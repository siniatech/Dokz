...
public class ResizeManager {
    ...
    public ResizeManager( IResponse0 invalidateResponse ) {
    ...
    public void startResize( Point startPoint, NeighbourContext panelsAround, Set<DokzPanel> panels ) {
    ...
    public boolean canStartResize( NeighbourContext panelsAround ) {
        return panelsAround.getPoint() == null && //
            ( isEwResize( panelsAround ) || isNsResize( panelsAround ) );
    }

    private boolean isNsResize( NeighbourContext panelsAround ) {
        return panelsAround.getNorth() != null && panelsAround.getSouth() != null;
    }

    private boolean isEwResize( NeighbourContext panelsAround ) {
